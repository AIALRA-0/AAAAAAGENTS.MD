...
流程图（源码：[`agents_docs/diagrams/how_it_works.mmd`](agents_docs/diagrams/how_it_works.mmd)）
...
- 初始化模板：[`agents_docs/prompts/init_prompt_template.md`](agents_docs/prompts/init_prompt_template.md)
- 日常对话模板：[`agents_docs/prompts/daily_prompt_template.md`](agents_docs/prompts/daily_prompt_template.md)
...
拍摄与替换说明：[`agents_assets/screenshots/SCREENSHOTS_GUIDE.md`](agents_assets/screenshots/SCREENSHOTS_GUIDE.md)

标准截图占位（当前仅声明，不生成图片）：

- 总览页：`agents_assets/screenshots/01-overview.png`
- 里程碑流程图：`agents_assets/screenshots/02-milestone-flow.png`
- 文件树浏览：`agents_assets/screenshots/03-tree-explorer.png`
- 编辑模式：`agents_assets/screenshots/04-edit-mode.png`
